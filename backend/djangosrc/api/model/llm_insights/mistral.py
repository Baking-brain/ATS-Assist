...
EDUCATION
University of Mumbai (GPA: 8/10)                                      
                                 Mumbai, India
BE in Computer Science and Engineering- Data Science                  
                          July 2022- July 2026
...
def analyze_resume(input_text):
    """Analyze a resume text using the Hugging Face API"""
    print("Before making call: ", input_text)
    try:
        messages = [
        ...
        print("\nafter making call, result: ", response)
